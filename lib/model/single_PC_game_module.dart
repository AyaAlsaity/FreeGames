...
class SinglePCModule {
    ...
    factory SinglePCModule.fromRawJson(String str) => SinglePCModule.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory SinglePCModule.fromJson(Map<String, dynamic> json) => SinglePCModule(
        id: json["id"],
        title: json["title"],
...
class MinimumSystemRequirements {
    ...
    factory MinimumSystemRequirements.fromRawJson(String str) => MinimumSystemRequirements.fromJson(json.decode(str));
